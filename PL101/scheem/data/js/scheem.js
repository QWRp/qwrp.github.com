SCHEEM = (function(){
    ...
    var result = {
        ...
        parse: function(input, startRule) {
            var parseFunctions = {
                "start": parse_start,
                "implicitbegin": parse_implicitbegin,
            ...
            function parse_implicitbegin() {
                ...
                if (result0 !== null) {
                    result0 = (function(offset, e1, e2) { return ['begin'].concat([e1]).concat(e2); })(pos0, result0[0], result0[1]);
                }
                if (result0 === null) {
                    pos = pos0;
                }
            ...
            function parse_atom() {
                ...
                if (result0 === null) {
                    ...
                    if (result0 === null) {
                        ...
                        if (result0 !== null) {
                            result0 = (function(offset, n, e) { var k = e[1] || []; return parseFloat(n.join("") + "." + k.join("")); })(pos0, result0[0], result0[1]);
                        }
                        if (result0 === null) {
                            pos = pos0;
                        }
